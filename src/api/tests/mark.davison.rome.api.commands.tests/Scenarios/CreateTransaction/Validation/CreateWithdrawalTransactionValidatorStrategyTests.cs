...
public sealed class CreateWithdrawalTransactionValidatorStrategyTests
{
    ...
    [Test]
    [MethodDataSource(typeof(AccountTypeConstants), nameof(AccountTypeConstants.Expenses))]
